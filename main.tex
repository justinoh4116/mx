...
\begin{tabular}{ |c|c| } 
 ...
 Name & Volume \\
 \hline
 Beaker & \qty{100}{\mili\liter} \\
 Grad. Cylinder & \qty{10}{\mili\liter} \\
 Watch Glass & N/A \\
 \hline
\end{tabular}
\quad
...
\begin{tabular}{ |c|c| }
    ...
    Measurement & Value \\
    \hline
    Mass of M reactant (Trial 1) &  \\
    Mass of X reactant (Trial 1) &  \\
    Volume of 'water' (Trial 1) &  \\
    Mass of evaporation dish (Trial 1) &  \\
    Mass of evaporation dish and product (Trial 1) &  \\
    Mass of M reactant (Trial 2) &  \\
    Mass of X reactant (Trial 2) &  \\
    Volume of 'water' (Trial 2) &  \\
    Mass of evaporation dish (Trial 2) &  \\
    Mass of evaporation dish and product (Trial 2) &  \\
